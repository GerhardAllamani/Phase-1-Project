...
public class Operations {
    ...
    public static final String path = "src/dir/"; //relative path to file directory
    ...
    public void searchFile(String fileName){ //other search option instead of binary search
